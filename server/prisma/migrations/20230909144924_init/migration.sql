...
-- CreateTable
CREATE TABLE "RestrictedMembers" (
    "channel_id" INTEGER NOT NULL,
    "user_id" INTEGER NOT NULL,
    "time_limit" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
-- CreateIndex
CREATE UNIQUE INDEX "RestrictedMembers_channel_id_key" ON "RestrictedMembers"("channel_id");

-- CreateIndex
CREATE UNIQUE INDEX "RestrictedMembers_user_id_key" ON "RestrictedMembers"("user_id");
...
-- AddForeignKey
ALTER TABLE "RestrictedMembers" ADD CONSTRAINT "RestrictedMembers_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "UserAccount"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
